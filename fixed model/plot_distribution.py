...
#model_path = '/home/lab606a/catkin_ws/src/pointcloud/models/not_fixed/prediction_all_not_fixed'
...
data_namee = './data/' + name + '_model_error_distribution.csv'
...
pic_name = './pic/' + name + '_distribution.png'
