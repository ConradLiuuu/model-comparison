...
acc_png = './history/500_data/' + name + '_accuracy.png'
plt.savefig(acc_png)
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
loss_png = './history/500_data/' + name + '_loss.png'
plt.savefig(loss_png)

# saved model
model_path = './saved model/500_data/prediction_not_fixed_bidirection_' + name 
